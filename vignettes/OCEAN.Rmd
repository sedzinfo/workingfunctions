...
round(cor(df_ocean[,grep("O",names(df_ocean))]),2)
round(cor(df_ocean[,grep("C",names(df_ocean))]),2)
round(cor(df_ocean[,grep("E",names(df_ocean))]),2)
round(cor(df_ocean[,grep("A",names(df_ocean))]),2)
round(cor(df_ocean[,grep("N",names(df_ocean))]),2)
