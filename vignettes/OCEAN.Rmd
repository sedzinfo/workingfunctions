...
plot_corrplot(mydata=stats::cor(df_ocean_reversed[,grep("O",names(df_ocean_reversed))]),base_size=20,title="Openness")
plot_corrplot(mydata=stats::cor(df_ocean_reversed[,grep("C",names(df_ocean_reversed))]),base_size=20,title="Conscientiousness")
plot_corrplot(mydata=stats::cor(df_ocean_reversed[,grep("E",names(df_ocean_reversed))]),base_size=20,title="Extraversion")
plot_corrplot(mydata=stats::cor(df_ocean_reversed[,grep("A",names(df_ocean_reversed))]),base_size=20,title="Agreeableness")
plot_corrplot(mydata=stats::cor(df_ocean_reversed[,grep("N",names(df_ocean_reversed))]),base_size=20,title="Neuroticism")
...
response_frequencies<-plot_response_frequencies(df_ocean_reversed,reorder=FALSE)
