...
plot_corrplot(mydata=stats::cor(df_ocean_reversed[,grep("O",names(df_ocean_reversed))]),base_size=20)
plot_corrplot(mydata=stats::cor(df_ocean_reversed[,grep("C",names(df_ocean_reversed))]),base_size=20)
plot_corrplot(mydata=stats::cor(df_ocean_reversed[,grep("E",names(df_ocean_reversed))]),base_size=20)
plot_corrplot(mydata=stats::cor(df_ocean_reversed[,grep("A",names(df_ocean_reversed))]),base_size=20)
plot_corrplot(mydata=stats::cor(df_ocean_reversed[,grep("N",names(df_ocean_reversed))]),base_size=20)

```

## Alpha
```{r alpha,fig.width=15,fig.height=10,echo=TRUE,message=FALSE,warning=FALSE,results='show',dev='png',fig.retina=2}
key<-list(O=grep("O",names(df_ocean_reversed),value=TRUE),
...
report_alpha(df=df_ocean_reversed,key=key,n.iter=10,check.keys=TRUE,file=NULL)
...
## Scree
```{r scree,fig.width=15,fig.height=10,echo=TRUE,message=FALSE,warning=FALSE,results='show',dev='png',fig.retina=2}
plot_scree(df_ocean_reversed[,grep("O",names(df_ocean_reversed),value=TRUE)],title="Openess")
