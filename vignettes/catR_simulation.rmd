...
```{r ,echo=TRUE,out.width=1000,warning=FALSE,message=FALSE,error=FALSE,fig.align="center",cache=TRUE}
...
```{r ,echo=TRUE,results="hide",out.width=1000,warning=FALSE,message=FALSE,error=FALSE,fig.align="center",cache=TRUE}
