...
``` r
compute_shrout(sperson, spersonitem, stime, spersontime, serror, m, k)
```
...
#> 1     r1f 0.2251901                            Reliability (between persons) of measures taken on the same fixed k time
#> 2     r1r 0.1284004                           Reliability (between persons) of measures taken on the same random k time
#> 3      rc 0.4795683                                                              Reliability (within persons) of change
#> 4     rkf 0.4657885        Reliability (between persons) of average measures taken over fixed m items and fixed k times
#> 5     rkr 0.3064935 Reliability (between persons) of different random time with same number of points k between periods
```
