...
#> 1        f1     3                1    0.7248    0.7246  0.6381    0.4673 2.632 0.01506 5.025 0.8402   0.4513       0.7294      0.7337        0.7379 Good and Acceptable
#> 2        f2     3                1    0.7094    0.7093  0.6203    0.4486 2.440 0.01592 4.989 0.8131   0.4452       0.6879      0.7058        0.7236 Good and Acceptable
#> 
#> $result_boot
#>   dimension items kaiser_criterion raw_alpha std_alpha g6(smc) average_r   s/n    ase unidim goodfit     var_r median_r
#> 1        f1     3                1    0.7292    0.7291  0.6431    0.4729 2.692 0.2199 0.8075  0.9983 0.0007201   0.4865
#> 2        f1     3                1    0.7381    0.7381  0.6532    0.4844 2.818 0.2054 0.8187  0.9988 0.0004615   0.4730
#> 3        f2     3                1    0.6870    0.6868  0.5965    0.4223 2.193 0.2942 0.7525  0.9959 0.0020390   0.4418
#> 4        f2     3                1    0.7246    0.7247  0.6375    0.4674 2.633 0.2268 0.8024  0.9993 0.0003162   0.4775
#> 
#> $result_item_statistics
#>   dimension question raw_alpha    n  raw_r  std_r  r_cor r_drop  mean    sd     1     2     3     4     5     6     7     8     9 miss
#> 1        f1       X1    0.7248 1000 0.7837 0.7887 0.6078 0.5192 5.014 1.024 0.001 0.002 0.067 0.225 0.387 0.257 0.057 0.004 0.000    0
...
#> $result_total
#>   dimension items kaiser_criterion raw_alpha std_alpha g6(smc) average_r   s/n     ase  mean     sd median_r boot_ci_2_5% boot_ci_50% boot_ci_97_5%     alpha_criterion
#> 1        f1     3                1    0.7248    0.7246  0.6381    0.4673 2.632 0.01506 5.025 0.8402   0.4513       0.7278      0.7288        0.7299 Good and Acceptable
#> 2        f2     3                1    0.7094    0.7093  0.6203    0.4486 2.440 0.01592 4.989 0.8131   0.4452       0.6997      0.7061        0.7124 Good and Acceptable
#> 
#> $result_boot
#>   dimension items kaiser_criterion raw_alpha std_alpha g6(smc) average_r   s/n    ase unidim goodfit     var_r median_r
#> 1        f1     3                1    0.7278    0.7277  0.6411    0.4711 2.672 0.2221 0.8059  0.9989 0.0004743   0.4812
#> 2        f1     3                1    0.7299    0.7304  0.6439    0.4745 2.709 0.2175 0.8095  0.9996 0.0001656   0.4739
#> 3        f2     3                1    0.6994    0.6998  0.6091    0.4373 2.331 0.2708 0.7706  0.9990 0.0004520   0.4393
#> 4        f2     3                1    0.7128    0.7135  0.6245    0.4536 2.491 0.2471 0.7883  0.9993 0.0003235   0.4513
#> 
#> $result_item_statistics
#>   dimension question raw_alpha    n  raw_r  std_r  r_cor r_drop  mean    sd     1     2     3     4     5     6     7     8     9 miss
#> 1        f1       X1    0.7248 1000 0.7837 0.7887 0.6078 0.5192 5.014 1.024 0.001 0.002 0.067 0.225 0.387 0.257 0.057 0.004 0.000    0
