...
- [`compute_raw_alpha()`](https://sedzinfo.github.io/rwf/reference/compute_raw_alpha.md)
...
- [`compute_shrout()`](https://sedzinfo.github.io/rwf/reference/compute_shrout.md)
...
- [`compute_text_similarity()`](https://sedzinfo.github.io/rwf/reference/compute_text_similarity.md)
...
- [`plot_confusion_extended()`](https://sedzinfo.github.io/rwf/reference/plot_confusion_extended.md)
...
- [`plot_duplicate_y_axis()`](https://sedzinfo.github.io/rwf/reference/plot_duplicate_y_axis.md)
  : Duplicate the y axis on the right side of a ggplot
- [`plot_hinvert_title_grob()`](https://sedzinfo.github.io/rwf/reference/plot_hinvert_title_grob.md)
...
- [`str_aes()`](https://sedzinfo.github.io/rwf/reference/str_aes.md) :
...
- [`str_mgsub()`](https://sedzinfo.github.io/rwf/reference/str_mgsub.md)
...
- [`str_proper()`](https://sedzinfo.github.io/rwf/reference/str_proper.md)
...
- [`str_split_df()`](https://sedzinfo.github.io/rwf/reference/str_split_df.md)
...
- [`str_sub()`](https://sedzinfo.github.io/rwf/reference/str_sub.md) :
  Extract n characters from the left or right of a string
- [`str_trim_df()`](https://sedzinfo.github.io/rwf/reference/str_trim_df.md)
