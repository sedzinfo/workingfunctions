...
#> $check
#>    NAMES EMPTY null na NOT_NA NAN INF FIN RANGE   MEAN MEDIAN     SD   MIN   MAX    MODE   TYPE   CLASS FACTOR
#> 1    mpg     0    0  5     27   0   0  27    24   20.4   19.2   6.36  10.4  33.9 numeric double numeric  FALSE
#> 2    cyl     0    0  5     27   0   0  27     4   6.22      6   1.78     4     8 numeric double numeric  FALSE
#> 3   disp     0    0  5     27   0   0  27    25  228.6  167.6 121.56  71.1   472 numeric double numeric  FALSE
#> 4     hp     0    0  5     27   0   0  27    19 145.63    123  70.14    52   335 numeric double numeric  FALSE
#> 5   drat     0    0  5     27   0   0  27    21   3.54   3.62   0.53  2.76  4.93 numeric double numeric  FALSE
#> 6     wt     0    0  5     27   0   0  27    25   3.24   3.44    0.9 1.615 5.424 numeric double numeric  FALSE
#> 7   qsec     0    0  5     27   0   0  27    26  17.93  17.82   1.75  14.6  22.9 numeric double numeric  FALSE
