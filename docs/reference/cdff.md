...
#> 1    mpg     0    0  0     32   0   0  32    25  20.09  19.20   6.03 10.4 33.9
#> 2    cyl     0    0  0     32   0   0  32     3   6.19   6.00   1.79    4    8
#> 3   disp     0    0  0     32   0   0  32    27 230.72 196.30 123.94 71.1  472
#> 4     hp     0    0  0     32   0   0  32    22 146.69 123.00  68.56   52  335
#> 5   drat     0    0  0     32   0   0  32    22   3.60   3.70   0.53 2.76 4.93
#> 6     wt     0    0  0     32   0   0  32    29   3.22   3.33   0.98 1.51 5.42
#> 7   qsec     0    0  0     32   0   0  32    30  17.85  17.71   1.79 14.5 22.9
#> 8     vs     0    0  0     32   0   0  32     2   0.44   0.00   0.50    0    1
#> 9     am     0    0  0     32   0   0  32     2   0.41   0.00   0.50    0    1
#> 10  gear     0    0  0     32   0   0  32     3   3.69   4.00   0.74    3    5
#> 11  carb     0    0  0     32   0   0  32     6   2.81   2.00   1.62    1    8
...
#> 3   disp     0    0  0     32   0   0  32    27   NA     NA NA  108 95.1
#> 4     hp     0    0  0     32   0   0  32    22   NA     NA NA  105   97
...
#> 1            Mazda.RX4     0    0  0     11   0   0  11    10 29.91   4.00
#> 2        Mazda.RX4.Wag     0    0  0     11   0   0  11    10 29.98   4.00
#> 3           Datsun.710     0    0  0     11   0   0  11     8 23.60   4.00
...
#> 7           Duster.360     0    0  0     11   0   0  11    10 59.72   4.00
#> 8            Merc.240D     0    0  0     11   0   0  11    10 24.63   4.00
#> 9             Merc.230     0    0  0     11   0   0  11    10 27.23   4.00
#> 10            Merc.280     0    0  0     11   0   0  11    10 31.86   4.00
#> 11           Merc.280C     0    0  0     11   0   0  11    10 31.79   4.00
#> 12          Merc.450SE     0    0  0     11   0   0  11     9 46.43   4.07
#> 13          Merc.450SL     0    0  0     11   0   0  11     9 46.50   3.73
...
#> 18            Fiat.128     0    0  0     11   0   0  11     8 19.44   4.00
#> 19         Honda.Civic     0    0  0     11   0   0  11     9 17.74   4.00
#> 20      Toyota.Corolla     0    0  0     11   0   0  11     8 18.81   4.00
#> 21       Toyota.Corona     0    0  0     11   0   0  11    10 24.89   3.70
#> 22    Dodge.Challenger     0    0  0     11   0   0  11    10 47.24   3.52
#> 23         AMC.Javelin     0    0  0     11   0   0  11    10 46.01   3.44
#> 24          Camaro.Z28     0    0  0     11   0   0  11    10 58.75   4.00
#> 25    Pontiac.Firebird     0    0  0     11   0   0  11    10 57.38   3.85
#> 26           Fiat.X1.9     0    0  0     11   0   0  11     8 18.93   4.00
#> 27       Porsche.914.2     0    0  0     11   0   0  11    11 24.78   4.43
#> 28        Lotus.Europa     0    0  0     11   0   0  11    10 24.88   4.00
#> 29      Ford.Pantera.L     0    0  0     11   0   0  11    11 60.97   5.00
#> 30        Ferrari.Dino     0    0  0     11   0   0  11    10 34.51   6.00
#> 31       Maserati.Bora     0    0  0     11   0   0  11    10 63.16   8.00
#> 32          Volvo.142E     0    0  0     11   0   0  11     9 26.26   4.00
...
#> 5  113.70   0  360 numeric double numeric  FALSE
...
#> 32  44.50   1  121 numeric double numeric  FALSE
#>                                           UNIQUES
#> 1      0, 1, 110, 16.46, 160, 2.62, 21, 3.9, 4, 6
#> 2     0, 1, 110, 160, 17.02, 2.875, 21, 3.9, 4, 6
#> 3          1, 108, 18.61, 2.32, 22.8, 3.85, 4, 93
#> 4  0, 1, 110, 19.44, 21.4, 258, 3, 3.08, 3.215, 6
#> 5   0, 17.02, 175, 18.7, 2, 3, 3.15, 3.44, 360, 8
#> 6   0, 1, 105, 18.1, 2.76, 20.22, 225, 3, 3.46, 6
#> 7   0, 14.3, 15.84, 245, 3, 3.21, 3.57, 360, 4, 8
#> 8     0, 1, 146.7, 2, 20, 24.4, 3.19, 3.69, 4, 62
#> 9   0, 1, 140.8, 2, 22.8, 22.9, 3.15, 3.92, 4, 95
#> 10 0, 1, 123, 167.6, 18.3, 19.2, 3.44, 3.92, 4, 6
#> 11 0, 1, 123, 167.6, 17.8, 18.9, 3.44, 3.92, 4, 6
#> 12    0, 16.4, 17.4, 180, 275.8, 3, 3.07, 4.07, 8
#> 13    0, 17.3, 17.6, 180, 275.8, 3, 3.07, 3.73, 8
#> 14      0, 15.2, 18, 180, 275.8, 3, 3.07, 3.78, 8
#> 15  0, 10.4, 17.98, 2.93, 205, 3, 4, 472, 5.25, 8
#> 16       0, 10.4, 17.82, 215, 3, 4, 460, 5.424, 8
#> 17 0, 14.7, 17.42, 230, 3, 3.23, 4, 440, 5.345, 8
#> 18         1, 19.47, 2.2, 32.4, 4, 4.08, 66, 78.7
#> 19    1, 1.615, 18.52, 2, 30.4, 4, 4.93, 52, 75.7
#> 20        1, 1.835, 19.9, 33.9, 4, 4.22, 65, 71.1
#> 21 0, 1, 120.1, 2.465, 20.01, 21.5, 3, 3.7, 4, 97
#> 22  0, 15.5, 150, 16.87, 2, 2.76, 3, 3.52, 318, 8
#> 23  0, 15.2, 150, 17.3, 2, 3, 3.15, 3.435, 304, 8
#> 24  0, 13.3, 15.41, 245, 3, 3.73, 3.84, 350, 4, 8
#> 25 0, 17.05, 175, 19.2, 2, 3, 3.08, 3.845, 400, 8
#> 26          1, 1.935, 18.9, 27.3, 4, 4.08, 66, 79
#> 27                                     11 Uniques
#> 28 1, 1.513, 113, 16.9, 2, 3.77, 30.4, 4, 5, 95.1
#> 29                                     11 Uniques
#> 30   0, 1, 145, 15.5, 175, 19.7, 2.77, 3.62, 5, 6
#> 31     0, 1, 14.6, 15, 3.54, 3.57, 301, 335, 5, 8
#> 32      1, 109, 121, 18.6, 2, 2.78, 21.4, 4, 4.11
#> 
cdff(df=mtcars)
#> $summary
#>   COLLUMNS ROWS TOTAL EMPTY null NAN na INF FIN FACTOR
...
#> $check
#>    NAMES EMPTY null na NOT_NA NAN INF FIN RANGE   MEAN MEDIAN     SD  MIN  MAX
#> 1    mpg     0    0  5     27   0   0  27    24  20.24  19.20   6.32 10.4 33.9
#> 2    cyl     0    0  5     27   0   0  27     4   6.00   6.00   1.84    4    8
#> 3   disp     0    0  5     27   0   0  27    25 238.11 258.00 132.03 71.1  472
#> 4     hp     0    0  5     27   0   0  27    21 146.07 123.00  67.04   52  335
#> 5   drat     0    0  5     27   0   0  27    19   3.65   3.77   0.55 2.76 4.93
#> 6     wt     0    0  5     27   0   0  27    26   3.22   3.21   1.05 1.51 5.42
#> 7   qsec     0    0  5     27   0   0  27    27  17.74  17.60   1.59 14.5 20.2
#> 8     vs     0    0  5     27   0   0  27     3   0.37   0.00   0.49    0    1
#> 9     am     0    0  5     27   0   0  27     3   0.41   0.00   0.50    0    1
#> 10  gear     0    0  5     27   0   0  27     4   3.74   4.00   0.76    3    5
#> 11  carb     0    0  5     27   0   0  27     6   2.63   2.00   1.33    1    6
#>       MODE   TYPE   CLASS FACTOR
#> 1  numeric double numeric  FALSE
#> 2  numeric double numeric  FALSE
#> 3  numeric double numeric  FALSE
...
#> 2            age     0    0  0    248   0   0 248    21 31.50     31  5.25   21
...
#> 1 6-11 numeric integer  factor   TRUE 0-5yrs, 12+ yrs, 6-11yrs
...
#> 7    9 numeric integer integer  FALSE               83 Uniques
...
#> 1 6-11 numeric integer  factor   TRUE
...
#> 7    9 numeric integer integer  FALSE
