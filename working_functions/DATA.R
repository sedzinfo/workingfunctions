...
#'
#' @source
#' Collected via an online personality test with informed consent (~2012). The data were obtained from kaggle https://www.kaggle.com/datasets/lucasgreenwell/ocean-five-factor-personality-test-responses.
#'
#' @examples
#' data(bfi_data)
#' head(bfi_data)
