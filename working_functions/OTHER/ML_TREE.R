...
#' train_test_classification<-rwf::k_fold(df=infert,model_formula=infert_formula)
#' train_test_regression<-rwf::k_fold(df=MASS::Boston,model_formula=boston_formula)
#' train_test_classification<-rwf::k_fold(df=infert,
#'                                                        model_formula=infert_formula)
#' train_test_regression<-rwf::k_fold(df=MASS::Boston,
