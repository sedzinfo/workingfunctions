...
#
##########################################################################################
#AGREE.COEFF3.RAW.R (September 24,2015)
...
#when the input data file is in the form of nxr matrix or data frame showing the actual ratings each rater (column) assigned to each subject (in row).
#That is n = number of subjects,and r = number of raters. A typical table entry (i,g) represents the rating associated with subject i and rater g. 
...
#===========================================================================================
#gwet.ac1.raw: Gwet's AC1/Ac2 coefficient (Gwet(2008)) and its standard error for multiple raters when input dataset is a nxr matrix of alphanumeric ratings from n subjects and r raters 
#The input data "ratings" is a nxr data frame of raw alphanumeric ratings from n subjects and r raters. Exclude all subjects that are not rated by any rater.
...
##########################################################################################
#=====================================================================================
#fleiss.kappa.raw: This function computes Fleiss' generalized kappa coefficient (see Fleiss(1971)) and its standard error for 3 raters or more 
#when input dataset is a nxr matrix of alphanumeric ratings from n subjects and r raters.
#The input data "ratings" is a nxr data frame of raw alphanumeric ratings from n subjects and r raters. Exclude all subjects that are not rated by any rater.
...
##########################################################################################
#=====================================================================================
#krippen.alpha.raw: This function computes Krippendorff's alpha coefficient (see Krippendorff(1970,1980)) and its standard error for 3 raters or more
#when input dataset is a nxr matrix of alphanumeric ratings from n subjects and r raters.
#-------------
...
##########################################################################################
#===========================================================================================
#conger.kappa.raw: Conger's kappa coefficient (see Conger(1980)) and its standard error for multiple raters when input dataset is a nxr matrix of alphanumeric ratings
#from n subjects and r raters 
#-------------
#The input data "ratings" is a nxr data frame of raw alphanumeric ratings from n subjects and r raters. Exclude all subjects that are not rated by any rater.
...
##########################################################################################
#===========================================================================================
#bp.coeff.raw: Brennan-Prediger coefficient (see Brennan & Prediger(1981)) and its standard error for multiple raters when input dataset is a nxr matrix of alphanumeric ratings 
#from n subjects and r raters 
#-------------
#The input data "ratings" is a nxr data frame of raw alphanumeric ratings from n subjects and r raters. Exclude all subjects that are not rated by any rater.
