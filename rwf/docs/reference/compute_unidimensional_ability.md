...
- a:
  ...
  numeric vector discrimination parameters

- b:

  numeric vector difficulty parameters

- g:

  numeric vector guessing parameters

- d:

  numeric scaling constant usually it is a value that approximating
  1.749

- u:

  numeric vector responses

- lim_theta:

  vector minimum and maximum value of theta
