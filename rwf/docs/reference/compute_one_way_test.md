...
#>              formula                    method ss_effect ss_error ms_effect
#> 1 bp_before ~ agegrp Assuming homoscedasticity   2485.55 12952.15  1242.775
#>   ms_error     etasq partial.etasq   omegasq partial.omegasq  cohens.f
#> 1 110.7021 0.1610052     0.1610052 0.1456192       0.1456192 0.4380668
#>       power statistic df_effect df_error            p
#> 1 0.9999993   11.2263         2      117 3.466707e-05
compute_one_way_test(formula=form,df=df_blood_pressure,var.equal=FALSE)
#>              formula                      method ss_effect ss_error ms_effect
#> 1 bp_before ~ agegrp Assuming heteroscedasticity  48.00725 156.0266  24.00362
#>   ms_error     etasq partial.etasq   omegasq partial.omegasq  cohens.f
#> 1 2.017238 0.2352906     0.2352906 0.2134071       0.1537287 0.5546947
#>       power statistic df_effect df_error            p
#> 1 0.9999877  11.89925         2 77.34665 3.121909e-05
...
#> ------------------------------------------------------------------------
#> 0.161 |         0.161 |   0.146 |           0.146 |     0.147 |    0.438
#>       |               |         |                 |           |         
#> 
#> etasq |      term |     sumsq |  df |   meansq | statistic | p.value | power
#> ----------------------------------------------------------------------------
#> 0.161 |    agegrp |  2485.550 |   2 | 1242.775 |    11.226 |  < .001 | 0.993
