...
- [`simulate_correlation_from_sample()`](https://sedzinfo.github.io/rwf/reference/simulate_correlation_from_sample.md)
  : Generate a dataframe that produces the same correlation matrix as
  the input dataframe
...
- [`plot_acf()`](https://sedzinfo.github.io/rwf/reference/plot_acf.md) :
  Plot autocorrelation function of correlation covariance and partial
  correlation
...
- [`round_dataframe()`](https://sedzinfo.github.io/rwf/reference/round_dataframe.md)
  : Round dataframe
- [`padNA()`](https://sedzinfo.github.io/rwf/reference/padNA.md) : pad
  NA's to collumns in dataframe
...
- [`swap()`](https://sedzinfo.github.io/rwf/reference/swap.md) : Reverse
  a numeric vector
