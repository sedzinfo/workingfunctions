...
ggplot(quailData,aes(Groups,Egg_Percent)) + geom_boxplot() +  labs(y="Percentage of Eggs Fertilised",x="Group")
ggplot(quailData,aes(Groups,Latency)) + geom_boxplot() + labs(y="Time Taken to Initiate Copulation",x="Group")
