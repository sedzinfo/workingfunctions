...
viagraData<-read.delim("/media/dimitrios/SONY/R/Data/Reference/Field/ViagraCovariate.dat",header=TRUE)
...
summary(anovaModel)
#--------Robust methods--------
invisibilityData<-read.delim("/media/dimitrios/SONY/R/Data/Reference/Field/CloakofInvisibility.dat",header=TRUE)
...
#--------Self Test----------
contrastData<-read.delim("/media/dimitrios/SONY/R/Data/Reference/Field/Contrast.dat",header=TRUE)
...
#-------labcoat leni----------------
#Load the data:
murisData<-read.delim("/media/dimitrios/SONY/R/Data/Reference/Field/Muris et al. (2008).dat",header=TRUE)
...
#--------Smart Alex Task 1----------
#Load in the data:
stalkerData<-read.delim("/media/dimitrios/SONY/R/Data/Reference/Field/Stalker.dat",header=TRUE)
...
#--------Smart Alex Task 2----------
#Load the data:
hangoverData<-read.delim("/media/dimitrios/SONY/R/Data/Reference/Field/HangoverCure.dat",header=TRUE)
...
#--------Smart Alex Task 3----------
#Load in the data:
elephantData<-read.delim("/media/dimitrios/SONY/R/Data/Reference/Field/Elephant Football.dat",header=TRUE)
