...
psycholatefunctions::check(examData)
...
#--------Spearman's Rho----------
liarData=field_examples$`The Biggest Liar.dat`
...
boot.ci(boot_spearman)
#-------Point Biserial-----
catData=field_examples$pbcorr.csv
...
#-------------------------Smart Alex Task 1
essayData=field_examples$EssayMarks.dat
...
#Smart Alex Task 3--------
gradesData<-field_examples$grades.csv
