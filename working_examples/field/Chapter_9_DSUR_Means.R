...
#load the data
invisibility<-read.delim("/Data/Field/invisibility.dat",header=TRUE)
...
# t-test
t.test(x,y=NULL,alternative=c("two.sided","less","greater"),mu=0,paired=FALSE,var.equal=FALSE,conf.level=0.95,na.action=na.exclude)
